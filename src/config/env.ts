...
export const env: EnvironmentConfig = {
  ...
  GOOGLE_SHEETS_ATHLETES_SHEET_NAME: getEnvVar('GOOGLE_SHEETS_ATHLETES_SHEET_NAME', 'Athletes'),
  GOOGLE_SHEETS_BOATS_SHEET_NAME: getEnvVar('GOOGLE_SHEETS_BOATS_SHEET_NAME', 'Boats'),
  GOOGLE_SHEETS_PRACTICE_SESSIONS_SHEET_NAME: getEnvVar('GOOGLE_SHEETS_PRACTICE_SESSIONS_SHEET_NAME', 'Practice Sessions'),
